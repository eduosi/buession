...
/* $Id: config/properties.h 310447 2011-12-22 19:54:34Z Teng Yong $ */

#ifndef BUESSION_CONFIG_PROPERTIES_H
#define BUESSION_CONFIG_PROPERTIES_H

extern zend_class_entry *buession_config_properties_ce;

#define BUESSION_CONFIG_PROPERTIES_ME(method, arguments, flags) ZEND_ME(buession_config_properties, method, arguments, flags)

#define config_properties_parse_value(value, result)	\
	do{	\
...
#endif	/* BUESSION_CONFIG_PROPERTIES_H */
